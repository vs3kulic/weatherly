...
## Technical
[-] Research public weather forecast APIs (Meteo)
[-] Check API URL and Response structure (JSON)
[-] Check how to perform http request
[-] Check how to parse JSON object
[-] Create a models.py file 
[-] Create a Weather class
[-] Read public openstreetmap API documentation (Nominatim)
[-] Create a City class
